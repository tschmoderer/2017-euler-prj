...
echo "You are in the non uniform nodes distribution case."
echo "Nodes will be print like : "
echo "From 0 to 0.6 --> $N nodes"
...
# Pre processing 
if [ ! -d Results/Non\ Uniform/$N\ Nodes ]; then 
mkdir Results/Non\ Uniform/$N\ Nodes
else
rm Results/Non\ Uniform/$N\ Nodes/*
fi 
...
ffmpeg  -framerate $f -i "img/$dir/%d.png"  Results/Non\ Uniform/$N\ Nodes/$dir.gif -y
# Save Memory space : 
rm data/$dir/*
rm img/$dir/*
done

mv data/dt.dat Results/Non\ Uniform/$N\ Nodes/
mv img/initial_condition_$N\_Nodes.png Results/Non\ Uniform/$N\ Nodes/
mv img/chock_$N\_Nodes.png Results/Non\ Uniform/$N\ Nodes/

#tar -zcvf Results/Non\ Uniform/$N\ Nodes/data_$N\_Nodes.tar.gz data/
#rm -r data/*
#rm -r img/*
...
echo "# Results are available in Results/Non\ Uniform/N Nodes #"
echo "#                                                       #"
echo "#########################################################"
echo ""
