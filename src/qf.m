...
%-- FUNCTION QF --%
%
% Compute the second member of the scheme, namely the approximation of the space derivative when either the mesh is unifrm or not
% Compute the biggest time step possible
%
%	In : 
%	  	- U : vector of state
%			- gamma : the constant of the gas 
% 		- theta : the parameter for the minmod function
%			- dx : size of each computing cell
%			- cfl : Courant's number 
%
% Out : 
%			- q : the approximation of the spatial derivation in each cell
%			- dt : the biggest time step 
%
%	Author : 
% 	- Timothée Schmoderer
%
